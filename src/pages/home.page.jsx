...
export default function HomePage() {
  ...
  return <HomeLayout brand="WeatherWeb" links={links} localDetails={localDetails} Map={Map} HourlyForecast={HourlyForecast} DailyForecast={DailyForecast} weatherDetails={weatherDetails} />;
}
